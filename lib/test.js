(function() {
  ...
  this["use partial freezing (3/3)"] = function() {
    ...
    assert.ok(d.open_vz === open_vz, '^lft@95^');
    ...
    lets(d, function(d) {
      ...
      return assert.deepEqual(dsc.configurable, true, '^lft@99^');
    });
    lets(d, function(d) {
      var dsc;
      dsc = Object.getOwnPropertyDescriptor(d, 'open_vz');
      return assert.deepEqual(dsc.configurable, true, '^lft@100^');
    });
    return null;
  };
  ...
  this["may pass in null to lets_compute as getter, setter"] = function() {
    ...
    assert.ok(d.count === 1, '^lft@101^');
    assert.ok(d.count === 2, '^lft@102^');
    //.........................................................................................................
    counter = 0;
    d = lets({
      foo: 'bar'
    ...
    assert.ok(d.count === 1, '^lft@^');
    assert.ok(d.count === 2, '^lft@^');
    //.........................................................................................................
    counter = 0;
    d = lets({
      foo: 'bar'
    ...
    }), /must define getter or setter/, '^lft@^');
  };
